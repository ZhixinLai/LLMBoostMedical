...
For 2D image model training and evaluation, use the cmd line below. Can choose vit-small model vit_small_patch16_224 or vit_llama_small_patch16_224
...
Can choose vit-small model vit_small_patch16_224 or vit_llama_small_patch16_224
...
You can get the heatmap of each layer of 2D image classification models. First, go to ./2D_classification and prepare the dataset under ./datasets. Second, update the layer here. Then, run the cmd line below and the heatmap will be generated under ./dataset/CamSample
